...
$$
 LLR_{r,i+1} = LLR_{r,i}+log(P_s(E'_{r,i}))+log(P_n(E'_{l,i})) - log(P_n(E'_{r,i}))-log(P_s(E'_{l,i}))
$$

and

$$ 
LLR_{p,i+1} = LLR_{p,i} + log(p_{right}P_s(E'_{r,i})P_n(E'_{l,i})+p_{left}P_n(E'_{r,i})P_s(E'_{l,i})) - log(P_n(E'_{r,i}))-log(P_n(E'_{l,i}))
...
In the firing rate model, sensory samples were sampled from $Pois(max(0,20E))$.

A python simulation is available [in the project's GitHub](https://github.com/matanmazor/reverseCorrelation/blob/main/simulations/poisson_noise.ipynb).
...
$$
 LLR_{r,i+1} = LLR_{r,i}+log(P_n(E'_{l,i})) - log(P_s(E'_{l,i}))
$$

and

$$ 
LLR_{p,i+1} = LLR_{p,i} + log(p_{right}P_n(E'_{l,i})+p_{left}P_s(E'_{l,i})) - log(P_n(E'_{l,i}))
$$
...
(ref:RC-fr-RC) Reverse correlation kernels derived from simulation of the firing rate model. Same conventions as Fig. \@ref(fig:RC-exp1-RC).

```{r RC-fr-RC, echo=FALSE, message=FALSE, fig.cap="(ref:RC-fr-RC)"}

knitr::include_graphics("figures/RC/fr/RC-fr-RC.png")
```
